...
describe('makeRefObj', () => {
  ...
  expected2 = {
    '11:11': 'Dinosaur Pile-Up', 'Powder Blue': 'Elbow'
  }
...
describe('formatComments', () => {
  ...
  it('Takes a single object in an array and a reference object and formats the object in the array correctly.', () => {
    ...
    expect(formatComments(singleComment, singleReference)).to.eql([{ author: 'butter_bridge', article_id: 12, created_at: desiredDate, body: "Oh, I've got compassion running out of my nose, pal! I'm the Sultan of Sentiment!", votes: 16 }])
  ...
  it('does the same for an array containing multiple objects.', () => {
    ...
    const multiRefObj = { 'Living in the shadow of a great man': 1, 'something else': 2 }
    const expected = [{ author: 'butter_bridge', article_id: 1, created_at: new Date(1479818163389), body: 'The beautiful thing about treasure is that it exists. Got to find out what kind of sheets these are; not cotton, not rayon, silky.', votes: 14 }, { author: 'icellusedkars', article_id: 2, created_at: new Date(1448282163389), body: 'Replacing the quiet elegance of the dark suit and tie with the casual indifference of these muted earth tones is a form of fashion suicide, but, uh, call me crazy — onyou it works.', votes: 100 }]
